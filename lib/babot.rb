...
module Babot
  class MyBot < Hipbot::Bot
    COMMANDS = %w( ping chuck gif github compare whois insult memes meme quotes explain google image youtube translate yomama developer_excuse designer_excuse clfln )
